...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets-site/css/gijgo.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets-site/css/slicknav.css')}}">
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-3">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="{{asset('assets_site/img/logo.png')}}" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div  class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                <div data-tilt class="thumb">
                                    <img src="{{asset('assets_site/img/performer/1.png')}}" alt="">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div  class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                                <div data-tilt class="thumb">
                                    <img src="{{asset('assets_site/img/performer/2.png')}}" alt="">
                                </div>
                                <div class="performer_heading">
                                    <h4>Protik Hasan</h4>
                                    <span>Acoustic drum</span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div  class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                <div data-tilt class="thumb">
                                    <img src="{{asset('assets_site/img/performer/3.png')}}" alt="">
                                </div>
                                <div class="performer_heading">
                                    <h4>Salmon Vicky</h4>
                                    <span>Acoustic drum</span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div   class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                                <div data-tilt class="thumb">
                                    <img src="{{asset('assets_site/img/performer/4.png')}}" alt="">
                                </div>
                                <div class="performer_heading">
                                    <h4>Filaris Habol</h4>
                                    <span>Acoustic drum</span>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="about_thumb">
                        <div class="shap_3  wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">
                            <img src="{{asset('assets_site/img/shape/shape_3.svg')}}" alt="">
                        </div>
                        <div class="thumb_inner  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <img src="{{asset('assets_site/img/about/about.png')}}" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="program_detail_wrap">
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="thumb wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="{{asset('assets_site/img/program_details/1.png')}}" alt="">
                                </div>
                        ...
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="{{asset('assets_site/img/program_details/2.png')}}" alt="">
                                </div>
                        ...
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="{{asset('assets_site/img/program_details/3.png')}}" alt="">
                                </div>
                                <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">Mr. Zosoldos</h4>
                            </div>
                        </div>
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="thumb wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="{{asset('assets_site/img/program_details/4.png')}}" alt="">
                                </div>
                                <h4 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".6s">Mr. Zosoldos</h4>
                            </div>
                        </div>
                    ...
                    <div class="brand_wrap">
                        <div class="brand_active owl-carousel">
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/1.png')}}" alt="">
                            </div>
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/2.png')}}" alt="">
                            </div>
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/3.png')}}" alt="">
                            </div>
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/4.png')}}" alt="">
                            </div>
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/5.png')}}" alt="">
                            </div>
                            <div class="single_brand text-center">
                                <img src="{{asset('assets_site/img/brand/1.png')}}" alt="">
                            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">WaohMonde</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
    ...
    <!-- JS here -->
    !-- JS here -->
    <script src="{{assets-site/js/vendor/modernizr-3.5.0.min.js')}}"></script>
    ...
    <script src="{{assets-site/js/ajax-form.js')}}"></script>
    ...
    <script src="{{assets-site/js/scrollIt.js')}}"></script>
    <script src="{{assets-site/js/jquery.scrollUp.min.js')}}"></script>
    <script src="{{assets-site/js/wow.min.js')}}"></script>
    <script src="{{assets-site/js/gijgo.min.js')}}"></script>
    <script src="{{assets-site/js/nice-select.min.js')}}"></script>
    <script src="{{assets-site/js/jquery.slicknav.min.js')}}"></script>
    <script src="{{assets-site/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{assets-site/js/tilt.jquery.js')}}"></script>
